...
<head>
    ...
    <script src="js/edgemapv2.js"></script>
    ...
    <script type="text/javascript" src="videoroom/janus.js" ></script>
    <script type="text/javascript" src="videoroom/videoroomtest.js"></script>
...
<body  style="background-color:#000000" >
    ...
    <div class="map-right-videoconference-button-inner">
        <center>
            <i data-feather="video" class="feather-normal" onClick="openJanus();"></i>
        </center>
    </div>
    </div>
    ...
    <div class="peerlistblock" id="peerlistblock" style="display: none;">
        ...
        <div class="map-videoroom-overlay" id="videoBlock" style="display: block;">
