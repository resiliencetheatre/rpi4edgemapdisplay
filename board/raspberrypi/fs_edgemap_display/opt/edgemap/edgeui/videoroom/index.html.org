			...
			<div class="container" id="details">
				<div class="row">
					<div class="col-md-12">
						...
						<table>
							<tr valign="top">
								<td><img src="img/videoroom-logo-picture-rpi.png" width=90%>
								</td>
								<td>
								</td>
							</tr>
						...
						<h3>Welcome to simplified video conferencing on Tactical Edge</h3> 
						
						<table>
							<tr>
								<td>
								<p>Browser based video conference using webRTC technologies. 
								<p>Press the <code>Join</code> button above to launch Video Room!</p>
								</td>
								<td> </td>
							</tr>
						</table>
			...
			<div class="container hide" id="videos">
						...
						<div class="panel panel-default hide">
                                                        <div class="panel-heading">
                                                                <h3 class="panel-title">Remote Video #0 <span class="label label-info hide" id="remote0"></span></h3>
                                                        </div>
                                                        <div class="panel-body relative" id="videoremote0"></div>
                                                </div>
